...
export const processLogs = (worklogArray, today = new Date()) => {
...
// because my data is so old i have to have the option to pretend that "TODAY" is another date
// when calling leave blank for actually today
export const calculateStatusProgression = async (worklogDataRaw, auditDueDateDataRaw, today = new Date()) => {
